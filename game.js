...
function showTextNode(textNodeIndex) {
  ...
  textElement.innerText = textNode.img + textNode.text
...
▀▄▄▄▄▄▄▄▄▄▄▄▄▄▀
  ...
  },
  {
    ...
    █░░█─▀▄░░░░░░░▄▀─█░░█
    `,
    text: "\n\nAs you continue your travels, Amanda spots a bear in the distance! What do you do?",
    options: [
      {
        text: 'Kill with bow for food',
        requiredState: (currentState) => currentState.Suppliescollected,
        setState: { NoBow: true, Bow: false },
        nextText: 14
      },
      {
        text: 'Kill with bow for food',
  ...
  },
  {
    ...
    ─────▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀─▀
    `,
    text: "\n\nYou find antibiotics for Jen and Blood for Bri! They both feel better right away.",
    options: [
      {
        text: 'Continue the journey',
        nextText: 29
  ...
  },
  {
    ...
    ─▀█────██▀█▀██────█▀──
    `,
    text: "\n\nBri collapses. She starts to cry and just wants hugs. You all hug her and say your goodbyes. \n\nSorry Bri, you are dead.",
    options: [
      {
  ...
  },
  {
    ...
    ░░░░░░░░░░░▐██▌
    `,
    text: "\n\nInside the safe is an Assault Rifle and ammo. Matt picks it up and you head out. \n\n You finally reach the town...",
    options: [
      {
        text: "Go to the grocery store",
        nextText: 27
...
`,
  ...
  },
  {
    ...
    ░███▄███░░▀░▀░░░░░▀▀░░
    `,
    text: "\n\nYou reach the grocery store, but the outside entrance is locked. \n\nUnlock the door -\n\n Rmhgz Zxxlfmg: 'tilxvibhgliv' ulooldvw yb gsv rmuznlfh 4 mfnyvih gszg nzgg xzm mvevi tvg lfg lu srh svzw",
    options: [
      {
        text: 'Unlocked door',
        nextText: 28
  ...
  },
  {
    id: 28,
    img: "",
    text: "You enter the grocery store and find all the food you need including vegan food for Matt and Amanda.",
    options: [
      {
        text: 'Continue the journey',
        nextText: 29
  ...
  },
  {
    ...
    ─────▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀─▀
    `,
    text: "\n\nYou find antibiotics for Jen! She takes them and feels better right away.",
    options: [
      {
        text: 'Continue the journey',
        nextText: 29
...
▄─▀▀▀▀▀▀▀─▄         
  ...
  },
  {
    ...
    ──▄████▄
    `,
    text: "\n\nJust as you are about to leave the house and evade the Ravegers, Rob says he has to take a shit.",
    options: [
      {
  ...
  },
  {
    ...
    ▄▀▀▀█▒▐░▀▀▄▀▀░▌▒█▀▀▀▄
    ▌▌▌▌▐▒▄▌░▄▄▄░▐▄▒▌▐▐▐▐`,
    text: "\n\nAs you all are arguing with Rob about NOT taking a shit, a zombie that was hiding in the bedroom hears you and runs viciously for Katie!",
    options: [
      {
  ...
  },
  {
    ...
    ───▄─▀████▀████▀─▄────
    ─▀█────██▀█▀██────█▀──`,
    text: "\n\nRob runs at the zombie to try and save katie, but he was too late. The zombie chewed her face off seconds before he got to her. He chops up the zombie in fury with his machete and screeams with anger, alerting your position to the Ravegers. \n\n They sneak up on the group and shoot up the house. \n\nWhile everyone is getting blasted away, Sadow was able to lob the grenade at the Ravegers and manages to kill them all. \n\n Unfortunately, it wasn't early enough. Everyone has died, except Sadow.",
    options: [
      {
        text: 'Continue...',
        nextText: 38
  ...
  },
  {
    ...
    ───▄─▀████▀████▀─▄────
    ─▀█────██▀█▀██────█▀──`,
    text: "\n\nThe group attempts to hold their ground against the Ravegers. They begin to shoot up the house. \n\nWhile everyone is getting blasted away, Sadow was able to lob the grenade at the Ravegers and manages to kill them all. \n\n Unfortunately, it wasn't early enough. Everyone has died, except Sadow.",
    options: [
      {
        text: 'Continue...',
        nextText: 38
  ...
  },
  {
    ...
    ╩╩╩╩╩╩▀▄▄▄▄▄▄▀╩╩╩╩╩╩
    `,
    text: "\n\nAs you eat the mushrooms, you think about the decisions you made during this journey. Slowly your reality begins to warp. The mushrooms send you back in time!",
    options: [
      {
        text: 'Move through time',
        requiredState: (currentState) => currentState.NoBow,
        setState: { NoBow: true, Bow: false, NoBoworGun: false, GunandBow: false, Suppliescollected: true},
        nextText: 13
      },
      {
        text: 'Move through time',
  ...
  },
  {
    ...
    ─▀█────██▀█▀██────█▀──
    `,
    text: "\n\nRob hears Katie screaming, runs out of the bathroom with no pants on and tries to save her, but he was too late. The zombie chewed her face off seconds before he got to her. He chops up the zombie in fury with his machete and screeams with anger, alerting your position to the Ravegers. \n\n They sneak up on the group and shoot up the house. \n\nWhile everyone is getting blasted away, Sadow was able to lob the grenade at the Ravegers and manages to kill them all. \n\n Unfortunately, it wasn't early enough. Everyone has died, except Sadow.",
    options: [
      {
        text: 'Continue...',
        nextText: 38
  ...
  },
  {
    ...
    ▄▄███████▄▄▄▄▄▄▄▄█▄▄▄▄
    `,
    text: "\n\nAs you patch up the Cabin, everyone agrees that this trip was a lot more than what anyone asked for, but necessary in order to survive. \n\nYou sit down and enjoy each others company. What a journey! ",
    options: [
      {
        text: 'To Be Continued...',
        nextText: 1
